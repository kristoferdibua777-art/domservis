...
class CreateDomServisRequestSources < ActiveRecord::Migration[7.2]
  ...
  def up
    create_table :dom_servis_request_sources, id: :integer do |t|
      t.string :name, null: false
      t.string :partner_key, null: false
      t.string :embed_token, null: false
      t.references :organization, foreign_key: true, type: :integer
    ...
    add_reference :dom_servis_dispatch_jobs, :request_source, foreign_key: { to_table: :dom_servis_request_sources }, type: :integer
